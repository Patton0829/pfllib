...
class FedSimGH(Server):
    def __init__(self, args, times):
        ...
        print("Aggregation: pairwise conflict projection + similarity-weighted averaging")
    ...
    def _compute_similarity_weights(self, projected_deltas):
        normalized_deltas = []
    ...
    def aggregate_parameters(self):
        ...
        adapted_weights = self._compute_similarity_weights(projected_deltas)
        weighted_delta = sum(
