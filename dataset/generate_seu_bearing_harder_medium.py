...
def generate_dataset(seed):
    ...
    base.dir_path = "dataset/seu_bearing_harder_medium/"
    base.medium_alpha = 0.18
    base.condition_affinity = 0.18
    base.min_labels_per_client = 2
    base.dataset_variant = "seu_bearing_harder_medium"
    base.dataset_display_name = "SEU-Bearing-Harder-Medium"
