...
dir_path = "dataset/xjtu_conflict_medium/"

train_ratio = medium.train_ratio
conflict_medium_alpha = 0.15
condition_affinity = 0.15
...
def generate_dataset(seed):
    ...
    medium.medium_alpha = conflict_medium_alpha
    medium.condition_affinity = condition_affinity
    medium.min_labels_per_client = min_labels_per_client
    medium.dataset_variant = "xjtu_conflict_medium"
    medium.dataset_display_name = "XJTU-Conflict-Medium"
